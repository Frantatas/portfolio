...
function App() {
  const projects = [
    ...
    },
    {
      ...
      description:
        "Built a React-based interface with embedded Metabase dashboards and a custom Express backend for secure token generation. Organized data visualizations for clarity and accessibility.",
      link: "https://github.com/Frantatas",
      type: "link",
    },
    {
      title: "HCI Final Project Prototype",
      description:
        "Interactive Figma prototype showcasing my final HCI project design and user flow.",
      embed:
        "https://embed.figma.com/proto/5lkDGiSQxqIp7auYLZbEOL/HCI-FINAL-PROJECT?node-id=20-2&starting-point-node-id=20%3A2&embed-host=share",
      type: "embed",
    },
    {
      title: "Kaiba Prototype",
      description:
        "Interactive Figma prototype presenting the Kaiba interface design and prototype flow.",
      embed:
        "https://embed.figma.com/proto/kR5GT9FuKNNH0wPABQ4iCV/Kaiba?node-id=10-63&starting-point-node-id=31%3A13&embed-host=share",
      type: "embed",
    },
  ];
        ...
        <section className="section-window">
          ...
          <div className="projects-grid">
            {projects.map((project) =>
              project.type === "embed" ? (
                <div className="project-card embed-card" key={project.title}>
                  <h3>{project.title}</h3>
